...
# We need this to save instance to test database. Otherwise, We can't save the instance to model.
pytestmark = pytest.mark.django_db


@pytest.fixture
def new_product(db, product_factory):
    # FactoryBoy Provide us two build in strategy one just use the object or save it to test database
    ...
    # product_obj = product_factory.create()  # this will create instance in test database
